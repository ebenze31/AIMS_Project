...
Route::post('/send_sos_to_officer', 'Aims_emergencysController@send_sos_to_officer');
...
Route::post('/patient/{patientId}/check_and_update', 'Aims_emergencysController@check_and_update');
