...
<br><br><br><br><br><br>
    <div class="container bg-white main-shadow" >
        <div class="row" style="margin: 15px ;">
            <div class="col-md-12" >
            	<br><br>
            	<h2 style="margin: 5px;">นโยบายเกี่ยวกับข้อมูลส่วนบุคคล เว็บไซต์ ViiCheck.com</h2>
            	<hr>
				...
				<p style="font-size: 16px; text-indent:30px;">8.1 ผู้เข้าใช้บริการทั่วไปมีสิทธิขอรับสำเนาข้อมูลส่วนบุคคลที่เกี่ยวกับตน (CooKies) ได้โดยต้องนําอุปกรณ์ที่ใช้ในการเข้าถึงเว็บไซต์ ViiCheck.com เช่น Notebook, PC, Tablet หรือ โทรศัพท์มือถือ มาที่บริษัทเพื่อขอรับสำเนาข้อมูลส่วนบุคคล<br></p>
