            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/detail') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Price</th><th>Type</th><th>Brand</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($detail as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->price }}</td><td>{{ $item->type }}</td><td>{{ $item->brand }}</td>
                                        <td>
                            ...
                            <div class="pagination-wrapper"> {!! $detail->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
