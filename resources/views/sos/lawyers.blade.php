...
@section('content')
<a id="tel1167" class="d-none" href="tel:1167"></a>

<!-- Button trigger modal -->
<button id="btn_1167" type="button" class="btn btn-primary d-none" data-toggle="modal" data-target="#modal_1167">
...
<script>
    document.addEventListener('DOMContentLoaded', (event) => {
        // console.log("START"); 
        setTimeout(function(){ 
          document.getElementById("tel1167").click(); 
        }, 100);
        document.getElementById("btn_1167").click();
