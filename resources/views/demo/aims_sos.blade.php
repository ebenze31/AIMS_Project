...
<form method="POST" action="/submit-sos">
    ...
    <div>
        ...
        <input type="text" name="report_platform" id="report_platform" value="{{ $report_platform }}" placeholder="Enter report_platform">
    </div>
    <div>
        <label for="name_reporter">name_reporter:</label>
        <input type="text" name="name_reporter" id="name_reporter" value="{{ $name_reporter }}" placeholder="Enter name_reporter">
    </div>
    <div>
        <label for="type_reporter">type_reporter:</label>
        <input type="text" name="type_reporter" id="type_reporter" value="{{ $type_reporter }}" placeholder="Enter type_reporter">
    </div>
    <div>
        <label for="phone_reporter">phone_reporter:</label>
        <input type="text" name="phone_reporter" id="phone_reporter" value="{{ $phone_reporter }}" placeholder="Enter phone_reporter">
    </div>
