            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('partner_viicheck' . '/' . $partner->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $partner->name }} </td></tr><tr><th> Phone </th><td> {{ $partner->phone }} </td></tr><tr><th> Line Group </th><td> {{ $partner->line_group }} </td></tr>
                                </tbody>
                            </table>
                        </div>
