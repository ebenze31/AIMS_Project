...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Parcel {{ $parcel->id }}</div>
                    <div class="card-body">
                        ...
                        <a href="{{ url('/parcel/' . $parcel->id . '/edit') }}" title="Edit Parcel"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Photo </th><td> {{ $parcel->photo }} </td></tr><tr><th> Name Staff </th><td> {{ $parcel->name_staff }} </td></tr><tr><th> Time In </th><td> {{ $parcel->time_in }} </td></tr>
                                </tbody>
                            </table>
                        </div>
