                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name Partner </th><td> {{ $partner_premium->name_partner }} </td></tr><tr><th> Id Partner </th><td> {{ $partner_premium->id_partner }} </td></tr><tr><th> Level </th><td> {{ $partner_premium->level }} </td></tr>
                                </tbody>
                            </table>
                        </div>
