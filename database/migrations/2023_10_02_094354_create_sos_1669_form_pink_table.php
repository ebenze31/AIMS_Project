...
class CreateSos1669FormPinkTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sos_1669_form_pinks', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            ...
            // $table->text('name_title_1')->nullable();
            ...
            // 
            // $table->text('people_type_1')->nullable();
            // $table->text('people_type_2')->nullable();
            // $table->text('people_type_3')->nullable();
            // $table->text('id_card')->nullable();
            // $table->text('people_country_1')->nullable();
            // $table->text('passport_1')->nullable();
            // $table->text('treatment_rights_1')->nullable();
            ...
            $table->string('time_of_measurement')->nullable();
            $table->string('vital_signs_t')->nullable();
            $table->string('vital_signs_bp')->nullable();
            $table->string('vital_signs_pr')->nullable();
            $table->string('vital_signs_rr')->nullable();
            $table->string('neuro_signs_e')->nullable();
            $table->string('neuro_signs_v')->nullable();
            $table->string('neuro_signs_m')->nullable();
    ...
    {
        Schema::dropIfExists('sos_1669_form_pinks');
    }
}
